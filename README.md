...
Fanen «Sjekk butikk» på siden: marker alt på butikkens søkeresultat (Ctrl+A, Ctrl+C), lim inn (Ctrl+V). Produktnavn og pris plukkes ut linje for linje, og hvert produkt slås opp mot katalogen (`docs/match.js`). Ingenting sendes noe sted. Testet mot Dekkonline, Thansen og Dekk365, men virker på enhver liste der produktnavnet starter med dekkmerket. En Tampermonkey-variant som merket produktene rett i butikken ble prøvd og droppet: lim-inn er godt nok, og krever ingen installasjon.
